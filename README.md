...
## Uretilen Dosyalar (Generated Artifacts)

Asagidaki dosyalar **repoda tutulmaz**, ilk calistirmada otomatik olarak uretilir:

| Dosya | Aciklama |
|---|---|
| `earthquakes_3_5_plus_scientific_v5.db` | SQLite katalog veritabani (AFAD apiv2 + `ridgecrest_catalog.csv`) |
